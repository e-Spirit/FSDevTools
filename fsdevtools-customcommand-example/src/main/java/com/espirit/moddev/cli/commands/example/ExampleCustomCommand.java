 ...
 */
@com.github.rvesse.airline.annotations.Command(name = "example-custom-command", description = "This is a custom command example implementation.", groupNames = "example-custom-group")
@Examples(examples = { "example-custom-command" }, descriptions = {"Executes the example command" })
