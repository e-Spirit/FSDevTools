...
public abstract class AbstractIntegrationTest {
    ...
    static String PROJECT_NAME = "fs-cli Project";
    static String PROJECT_NAME_WITH_DB = "fs-cli Project with db";
    ...
    public void initDefaultConfiguration(GlobalConfig command) {
        ...
        command.setFsMode(FsConnectionMode.HTTP);
        ...
        command.setPort(Integer.valueOf(System.getProperty("fsHttpPort", String.valueOf(command.getConnectionMode().getDefaultPort()))));
