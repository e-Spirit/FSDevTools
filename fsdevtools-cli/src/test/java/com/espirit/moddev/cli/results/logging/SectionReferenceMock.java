...
public class SectionReferenceMock implements SectionReference<SectionTemplate> {

    private final long _id;
    private final String _name;

    SectionReferenceMock(final long nodeId, final String name) {
        _id = nodeId;
        _name = name;
    }
    ...
    @Override
    public SectionTemplate getTemplate() throws ReferenceNotFoundException {
        return null;
    }

    @Override
    public void setTemplate(final SectionTemplate sectionTemplate) {

    }

    @Override
    public Section getReference() throws ReferenceNotFoundException {
        return null;
    }
    ...
    @Override
    public void setLifespan(final long l, final long l1) {
    ...
    @Override
    public void excludeFromOutput(final Language language) {
