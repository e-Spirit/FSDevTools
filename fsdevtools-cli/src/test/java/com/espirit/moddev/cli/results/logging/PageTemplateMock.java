...
public class PageTemplateMock implements PageTemplate {

    private final long _id;
    private final String _name;

    PageTemplateMock(final long nodeId, final String name) {
        _id = nodeId;
        _name = name;
    }
    ...
    @Override
    public Allowed createAllowed(final String s, final Template template) {
        return null;
    }

    @Override
    public Allowed createAllowed(final TemplateBody templateBody, final MasterTemplate masterTemplate) {
        return null;
    }

    @Override
    public List<Template> getAllowedTemplates(final String s) {
        return null;
    }

    @Override
    public List<MasterTemplate> getAllowedTemplates(final TemplateBody templateBody) {
        return null;
    }

    @Override
    public boolean isTemplateAllowed(final TemplateBody templateBody, final MasterTemplate masterTemplate) {
        return false;
    }

    @Override
    public List<? extends TemplateBody> getBodies() {
        return null;
    }

    @Override
    public TemplateBody getBody(final String s) {
        return null;
    }

    @Override
    public void setBodies(final List<? extends TemplateBody> list) {

    }

    @Override
    public TemplateBody createTemplateBody(final String s) {
        return null;
    }
}
